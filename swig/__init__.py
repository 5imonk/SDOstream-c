...
class SDOcluststream32(object):
    ...
    def __init__(self, observer_cnt, T, idle_observers, neighbour_cnt, chi_min, chi_prop, zeta, e, distance, seed):
        _dSalmon.SDOcluststream32_swiginit(self, _dSalmon.new_SDOcluststream32(observer_cnt, T, idle_observers, neighbour_cnt, chi_min, chi_prop, zeta, e, distance, seed))
    ...
    def fit_predict_with_sampling(self, data, labels, times, sampled):
        return _dSalmon.SDOcluststream32_fit_predict_with_sampling(self, data, labels, times, sampled)
...
class SDOcluststream64(object):
    ...
    def __init__(self, observer_cnt, T, idle_observers, neighbour_cnt, chi_min, chi_prop, zeta, e, distance, seed):
        _dSalmon.SDOcluststream64_swiginit(self, _dSalmon.new_SDOcluststream64(observer_cnt, T, idle_observers, neighbour_cnt, chi_min, chi_prop, zeta, e, distance, seed))
    ...
    def fit_predict_with_sampling(self, data, labels, times, sampled):
        return _dSalmon.SDOcluststream64_fit_predict_with_sampling(self, data, labels, times, sampled)
